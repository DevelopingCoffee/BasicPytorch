...
# build own dataset with helper class:
dataset = DataloaderCatsAndDogs(csv_file='cats_dogs.csv', root_dir='/Users/dirk/development/ba/torch_tut.py/dataset/cats_and_dogs', image_folder='cats_dogs_resized', transform=transforms.ToTensor() )
